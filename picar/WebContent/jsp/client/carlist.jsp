   ...
   -->
      <section id="post" class="wrapper bg-img" data-bg="banner2.jpg">
         <div class="inner">
            <article class="box">
               <header>
                  <center><h2>차량 리스트</h2></center>
                  <br />
               </header>
               <form action="carsearch" method="post">
				<div align="right">
				<input type="hidden" value="${carloc}" name="carloc">
				<input type="text" placeholder="차량 종류" name="carname" style="width:300px; display:inline;" />
				...
				<table border=1>
						...
						<c:forEach var="carlisty" items="${carlists}">
							<tr>	
								...
								<td><a href="cardetail?carnum=${carlisty.carnum}"><button>클릭!</button></a></td>
							</tr>
						</c:forEach>	
					</table>
				</c:if>
				...
				<div align="left">
				<input type="button" style="margin-left:1px; margin-right:548px;" value="뒤로가기" onclick="history.back(-1);" />
				<c:if test="${picarmember.gradeNo==30}"> 
				<input type="button" value="차량 등록" onclick="location.href='insertcar'">
				 </c:if>				
				</div>
			</article>
         </div>
