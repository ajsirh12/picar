...
<body class="subpage">
   ...
   <!-- Nav -->
      ...
      <section id="post" class="wrapper bg-img" data-bg="banner2.jpg">
         <div class="inner">
            <article class="box">
				<div align="center"><p>회원가입이 완료 되었습니다.</p></div> 
				<div align="center"><a href="login_input"><button>로그인</button></a></div>
	        	<div align="right"><a href="sign_up"><button>회원가입</button></a></div>   
	        </article>
	         </div>
	      </section>
	      <footer id="footer">
